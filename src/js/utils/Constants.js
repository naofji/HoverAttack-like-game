...
// 22→16, 9→6 に詰めた。22 は機体(24x24)より外まで輪が広がるため、砲台より
// 大きな光の輪が地形の上に重なり、「砲台の形がヘン」に見える一因になっていた
// （実機フィードバック）。16 はピボット(半径8)の2倍で砲台と一体に見える大きさ、
// 6 はランプの座(半径7)の内側で、輪が最後にランプへ吸い込まれて見える。
// 動く距離は 13px→10px と少し減るが、収束先がランプ本体になったぶん
// 「中心へ寄る」はかえって読みやすい
export const BEAM_LAMP_RING_OUTER = 16;
