...
// 右の列の左端。左右が近いと「どちらの手の話か目が迷う」と実機で指摘されたので、
// 左の列のいちばん長い説明（MOVE LEFT / RIGHT…で 68+218=286px）の右に 36px 空ける。
// 右の列のいちばん長い説明（GRENADE…で 68+250=318px）が、いちばん狭いパネル
// （設定の 720 から余白を引いた 656）に収まる上限でもある。**両側が同時に
// ぎりぎり**なので、文言を伸ばすとどちらかがはみ出す（テストが落ちる）
